...
public class CompraJdbc implements Serializable {
    ...
    private Set<CompraProdutoJdbc> compraProdutos = new HashSet<>();
    ...
    public Set<CompraProdutoJdbc> getCompraProdutos() {
        return compraProdutos;
    }

    public void setCompraProdutos(Set<CompraProdutoJdbc> compraProdutos) {
